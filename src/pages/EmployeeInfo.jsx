...
function EmployeeInfo() {
  ...
  const fetchEmployeeInfo = () => {
    axios
      .get("http://54.180.60.149:3000/selectOneAttendance", {
        params: { employeeSeq },
  ...
  return (
    <>
      {employeeData.empName && (
        <div
          className={
            employeeData.terminationDate ? "terminated" : "employeesinfo"
          }
        >
              ...
              <div className="employee-info-container">
                <div className="employee-info-top">
                  ...
                  {employeeData.terminationDate === null ? (
                    <div className="employee-btn-container">
                      <button
                        className="employee-btn-update"
                        onClick={() => openModal("updateEmp")}
                      >
                        정보 수정
                      </button>
                      <button
                        className="employee-btn-terminate"
                        onClick={() => openModal("terminateEmp")}
                      >
                        퇴사
                      </button>
                    </div>
                ...
                <div className="employee-line">
                  ...
                  <div className="employee-info-right">
                    ...
                    <div className="employee-info2">
                      {formatPhoneNumber(employeeData.phoneNumber)}
                    </div>
              ...
              <table>
                ...
                <tbody>
                  {attendanceData.length === 0 ? (
                    <tr>
                      <td className="tossface employeeinfo-empty" colSpan="5">
                        🏷️
                      </td>
                    </tr>
                  ) : (
