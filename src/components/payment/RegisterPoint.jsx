...
function RegisterPoint({
  ...
  const handleRegiPoint = () => {
    ...
    axios
      .post("http://54.180.60.149:3000/newPoint", RegiData, {
  ...
  return (
    <div className="registerpoint">
      ...
      <div className="registerpoint-text">
        회원정보가 없습니다
        <br />
        가입을 원하시면 비밀번호를 입력해주세요
      </div>
      <div className="registerpoint-container">
        ...
        />
        <button
          className="registerpoint-button"
          onChange={(e) => setPwd(e.target.value)}
          onClick={handleRegiPoint}
        >
          등록
        </button>
      </div>
